        ...
        <div style={{ padding: '24px' }}>
            <Row justify="center">
                <Col xs={24} sm={22} md={20} lg={18} xl={16}>
                    ...
                    <Paragraph style={{ textAlign: 'justify', fontSize: '16px', lineHeight: '1.8' }}>
                        At the core of our system is <strong>YOLOv10</strong>, a state-of-the-art object detection model implemented in Python. YOLOv10 enables real-time and accurate detection of vehicles, making it ideal for applications requiring high precision and speed. The backend of our system is built using <strong>NestJS</strong>, a scalable and efficient framework that ensures seamless communication with cameras and handles data processing efficiently. For structured and reliable data management, we utilize <strong>PostgreSQL</strong>, ensuring that all vehicle-related data is stored securely and can be retrieved for analysis. On the frontend, we leverage <strong>ReactJS</strong> to create an interactive and user-friendly interface, allowing users to easily interact with the system and visualize the results.
                    </Paragraph>
                    ...
                    <Row gutter={[16, 16]}>
                        <Col xs={24} sm={12} md={8}>
                            <Card title="YOLOv10" bordered={false}>
                                YOLOv10 is used for real-time vehicle detection, providing high accuracy and speed in identifying vehicles from video streams.
                            </Card>
                        </Col>
                        <Col xs={24} sm={12} md={8}>
